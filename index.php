...
<body>
  ...
  <main>
          <div class="containerQuestions">
                  ...
                  <?php foreach($domandeGoogle as $domanda => $value){?>
                            
                            <?php  foreach($value as $myKey){ ?>
                               
                              <h2 class="titoloDomanda"><?php echo $myKey["domanda"] ?></h2>
                              <p class="risposta">
                                 <?php echo $myKey["risposta"] ?>
                              </p>
                              <hr>
